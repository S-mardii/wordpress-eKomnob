<?php
    ...
    */
    ...
    function powr_button_menu() {
      add_menu_page( 'POWr Button', 'POWr Button', 'manage_options', 'powr-button-settings', powr_button_options, 'https://s3-us-west-1.amazonaws.com/powr/platforms/wordpress/16x16_icons/Button.png');
      add_submenu_page( 'powr-button-settings', 'POWr - Create', 'Create', 'manage_options', 'powr-button-create', powr_button_create_options);
      add_submenu_page( 'powr-button-settings', 'POWr - Manage', 'Manage', 'manage_options', 'powr-button-manage', powr_button_manage_options);
      add_submenu_page( 'powr-button-settings', 'POWr - Help', 'Help', 'manage_options', 'powr-button-help', powr_button_help_options);
    }
    function powr_button_options() {
      if ( !current_user_can( 'manage_options' ) )  {
        wp_die( __( 'You do not have sufficient permissions to access this page.' ) );
      }
      echo '<iframe id="powr-button" src="https://www.powr.io/wp/button" frameborder="0" width="100%" height="600px" style="position:absolute; top:0; left:0;z-index: 100;"></iframe>';
      echo '<script>';
      echo 'var ht = window.innerHeight - document.getElementById("wpadminbar").offsetHeight;';
      echo 'var iframe = document.getElementById("powr-button"); iframe.style.height = ht+"px"; iframe.height = ht;';
      echo '</script>';
    }
    function powr_button_create_options() {
      if ( !current_user_can( 'manage_options' ) )  {
        wp_die( __( 'You do not have sufficient permissions to access this page.' ) );
      }
      echo '<iframe id="powr-create-button" src="https://www.powr.io/wp-create/button?powr_token='.get_option('powr_token').'" frameborder="0" width="100%" height="600px" style="position:absolute; top:0; left:0;z-index: 100;"></iframe>';
      echo '<script>';
      echo 'var ht = window.innerHeight - document.getElementById("wpadminbar").offsetHeight;';
      echo 'var iframe = document.getElementById("powr-create-button"); iframe.style.height = ht+"px"; iframe.height = ht;';
      echo '</script>';
    }
    function powr_button_manage_options() {
      if ( !current_user_can( 'manage_options' ) )  {
        wp_die( __( 'You do not have sufficient permissions to access this page.' ) );
      }
      echo '<iframe id="powr-manage-button" src="https://www.powr.io/wp-manage/button" frameborder="0" width="100%" height="600px" style="position:absolute; top:0; left:0; z-index: 100;"></iframe>';
      echo '<script>';
      echo 'var ht = window.innerHeight - document.getElementById("wpadminbar").offsetHeight;';
      echo 'var iframe = document.getElementById("powr-manage-button"); iframe.style.height = ht+"px"; iframe.height = ht;';
      echo '</script>';
    }
    function powr_button_help_options() {
      if ( !current_user_can( 'manage_options' ) )  {
        wp_die( __( 'You do not have sufficient permissions to access this page.' ) );
      }
      echo '<iframe id="powr-help-button" src="https://www.powr.io/knowledge-base?src=wordpress" frameborder="0" width="100%" height="600px" style="position:absolute; top:0; left:0; z-index: 100;"></iframe>';
      echo '<script>';
      echo 'var ht = window.innerHeight - document.getElementById("wpadminbar").offsetHeight;';
      echo 'var iframe = document.getElementById("powr-help-button"); iframe.style.height = ht+"px"; iframe.height = ht;';
      echo '</script>';
    }
  ?>